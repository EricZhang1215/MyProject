package com.security.sso.authorization.config;
...
public class SsoSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http    //.csrf().disable()先禁用跨站访问功能
				...
				.antMatchers("/authentication/require",securityProperties.getBrowser().getSignInPage(), "/exit").permitAll()//这个页面不需要身份认证，其他都需要
				.anyRequest()//任何请求
